...
│   │   ├── Chip.vue            # Chip button — props: active?, readonly?, count?; default slot for label text; count renders an inline badge when provided; active state driven by [aria-pressed="true"] selector; readonly adds cursor-default pointer-events-none; scoped SCSS block
