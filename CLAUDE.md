...
│   │   │   ├── utils/
│   │   │   │   ├── buildExecutiveSummaryData.ts # exports buildExecutiveSummaryInput(campaigns: CampaignPerformance[], channels: Channel[]) → ExecutiveSummaryInput; computes portfolio totals, converts Channel[] to ChannelSummary[] (budgetShare/revenueShare/efficiencyGap/status), converts CampaignPerformance[] to CampaignSummary[]; delegates derived signals to getExecutiveSummaryDerivedInputs from common/analysis/
