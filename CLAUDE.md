...
│   │   │   │   ├── types.ts            # AiModel (id/model/display_name/provider/strength/strength_score/reason/limitReached) + ModelsResponse ({ models: AiModel[] }) — provider-layer model types; exported via providers/index.ts barrel
