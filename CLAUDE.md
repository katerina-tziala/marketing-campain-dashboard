...
│   │   │   ├── types/
│   │   │   │   └── index.ts            # Slim cross-feature AI type hub — provider/connection types only: AiProviderType, AiErrorCode, AiConnectionError; analysis meta-types: AiAnalysisType, AiAnalysisError; all response and output types live in ai-analysis/types/index.ts
│   │   │   ├── prompts/
