...
│   │   │   │       ├── AiAnalysis.vue          # Tab switcher — Tabs order: Summary first, Optimizer second; scrollable .panel-container; reads aiAnalysis.store activeTab + campaign.store portfolioScope; passes scope prop to ExecutiveSummaryAnalysis and BudgetOptimizationAnalysis; flat scoped .panel-container style
