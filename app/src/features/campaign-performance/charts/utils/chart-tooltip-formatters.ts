...
import { formatCurrency, formatPercentage, safeDivide } from '@/shared/utils';
...
export function formatChannelTooltip(channel: string): string {
  return `Channel: ${channel}`;
}

export function formatRoiTooltip(roi: number | null): string {
  return `ROI: ${formatPercentage(roi)}`;
}

export function formatBudgetTooltip(budget: number): string {
  return `Budget: ${formatCurrency(budget)}`;
}

export function formatRevenueTooltip(revenue: number): string {
  return `Revenue: ${formatCurrency(revenue)}`;
}

export function formatRoiBudgetScalingTooltipLines(item: RoiBudgetScalingTooltipItem): string[] {
  return [
...
export function formatBudgetTooltipLines(budget: number, totalBudget: number): string[] {
  return [
