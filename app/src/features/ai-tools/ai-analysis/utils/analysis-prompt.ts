...
import type {
  ...
  AnalysisProviderState,
  AnalysisResponse,
} from '../types';

type AnalysisPromptRunnerOverride = (
  type: AiAnalysisType,
  signal: AbortSignal,
...
type PromptBuilder = (context: AiAnalysisContext) => string;
...
function buildAnalysisPrompt(analysisContext: AnalysisPromptContext): string {
