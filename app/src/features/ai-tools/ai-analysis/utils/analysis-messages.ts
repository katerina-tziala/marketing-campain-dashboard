...
const UNUSABLE_RESPONSE = {
  ...
  message: 'Please try again. The result could not be processed.',
}
...
export const ANALYSIS_ERROR_MESSAGES: Record<AiErrorCode, { title: string; message: string }> = {
  ...
  'min-campaigns': { title: 'Budget optimization requires at least 2 campaigns', message: 'Please adjust the channel filter or add more campaign data.' },
