...
const aggressiveReallocation: BudgetOptimizerResponse = {
  ...
  recommendations: [
    ...
    },
    {
      ...
      toChannel: null,
      budgetShift: 1200,
      reason: 'Programmatic Display has delivered sub-1x ROI for two consecutive periods with no signs of recovery. Reducing the budget floor stops the bleed without full shutdown, freeing headroom for reallocation.',
  ...
  expansions: [
    {
      ...
      reason: 'Email automation scales near-linearly below list saturation. Win-Back already runs at 12x ROI — doubling the budget cap raises incremental revenue before diminishing returns set in.',
    ...
    },
    {
      ...
      reason: 'Affiliate partners have confirmed 40% unused capacity at current commission rates. Adding a performance bonus tier could unlock incremental conversions without upfront media spend.',
...
const conservativeOptimization: BudgetOptimizerResponse = {
  ...
  recommendations: [
    ...
    },
    {
      ...
      toChannel: null,
      budgetShift: 1500,
      reason: 'CTV Campaign has not converted meaningfully in the last three months despite sustained spend. Trimming to a holding budget preserves brand presence without continuing to bleed margin.',
...
const seasonalPivot: BudgetOptimizerResponse = {
  ...
  recommendations: [
    ...
    },
    {
      ...
      toChannel: null,
      budgetShift: 800,
      reason: 'Bing Ads sees a 35% seasonal drop in click volume during summer months. Reducing spend to a maintenance floor avoids paying for impressions that will not convert until Q3.',
  ...
  expansions: [
    {
      ...
      reason: 'Web Push currently runs on a minimal budget despite a 19x ROI. Summer flash-sale messaging drives click-through 30% above baseline — additional budget can be absorbed before saturation.',
    ...
    },
    {
      ...
      reason: 'Social CPMs drop 18% in July, making incremental reach cheaper than any other time of year. A burst spend window targets audiences already primed by the seasonal influencer push.',
  ...
  expansions: [
    {
      ...
      additionalBudget: 2000,
      reason: 'Podcast advertising is untapped in this portfolio. Mid-roll placements in finance and productivity shows align with the audience profile and offer CPMs below current Search rates.',
