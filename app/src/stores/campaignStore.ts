...
import type { Campaign, CampaignPerformance, PortfolioScope } from '@/shared/types/campaign'
import type { Channel } from '@/shared/types/channel'
import { buildChannelMap } from '@/shared/utils/campaign-channel'
import { computePortfolioAnalysis } from '@/shared/portfolio-analysis/portfolio-analysis'
...
export const useCampaignStore = defineStore('campaigns', () => {
  ...
  const filteredCampaigns = computed<CampaignPerformance[]>(() => selectedChannels.value.flatMap((channel) => channel.campaigns))
