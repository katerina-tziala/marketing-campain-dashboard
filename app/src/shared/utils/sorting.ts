...
export function sortWithNullsLast(
  ...
  return (
    compareNullsLast(a, b) ?? compareDirectional(a as string | number, b as string | number, dir)
  );
}
...
export function sortByValueDesc<T>(items: readonly T[], getValue: (item: T) => SortableValue): T[] {
