...
import { hasRevenueShareLead, hasRoiAbovePortfolio, isOverfundedUnderperformer } from '../checkers';
...
import { DEFAULT_CAMPAIGN_SIGNAL_THRESHOLDS, SIGNAL_REASONS } from './constants';

function hasCampaignScalingEfficiency(
  campaign: CampaignSummary,
  portfolioRoi: number | null,
): boolean {
  return hasRoiAbovePortfolio(campaign, portfolioRoi) && hasRevenueShareLead(campaign, 0);
}
...
function isBudgetScalingCandidate(campaign: CampaignSummary, portfolioRoi: number | null): boolean {
