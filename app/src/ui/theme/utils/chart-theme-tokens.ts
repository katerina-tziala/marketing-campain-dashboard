...
export function toChartColorPalette(t: ChartThemeTokens): string[] {
  return [
    // 500 (base)
    t.colorIndigo, t.colorPink, t.colorEmerald, t.colorOrange,
    t.colorViolet, t.colorCyan, t.colorAmber, t.colorRed,
    t.colorTeal, t.colorPurple, t.colorGreen, t.colorBlue,
    t.colorYellow, t.colorFuchsia, t.colorSky, t.colorLime, t.colorRose,
    // 400 (lighter)
    t.colorIndigoLight, t.colorPinkLight, t.colorEmeraldLight, t.colorOrangeLight,
    t.colorVioletLight, t.colorCyanLight, t.colorAmberLight, t.colorRedLight,
    t.colorTealLight, t.colorPurpleLight, t.colorGreenLight, t.colorBlueLight,
    t.colorYellowLight, t.colorFuchsiaLight, t.colorSkyLight, t.colorLimeLight, t.colorRoseLight,
    // 600 (darker)
    t.colorIndigoDark, t.colorPinkDark, t.colorEmeraldDark, t.colorOrangeDark,
    t.colorVioletDark, t.colorCyanDark, t.colorAmberDark, t.colorRedDark,
    t.colorTealDark, t.colorPurpleDark, t.colorGreenDark, t.colorBlueDark,
    t.colorYellowDark, t.colorFuchsiaDark, t.colorSkyDark, t.colorLimeDark, t.colorRoseDark,
  ]
}
