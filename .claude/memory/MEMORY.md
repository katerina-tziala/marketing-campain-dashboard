...
- [feedback_log_entries.md](feedback_log_entries.md) — CRITICAL: write docs/vibe-coding-logs.md entry after every code change, before responding — user corrected this multiple times
...
- [project_context.md](project_context.md) — Marketing Intelligence Dashboard: MBA project, docs complete (#680), portfolio domain @/shared/portfolio, per-tab autoRefreshEnabled, recent accessibility changes
- [feedback_vue_naming.md](feedback_vue_naming.md) — Vue templates use kebab-case for props/events; camelCase only in script
- [feedback_no_sync_logs.md](feedback_no_sync_logs.md) — Never write a docs/vibe-coding-logs.md entry for CLAUDE.md-only syncs — not a loggable event
